...
class Autotune_Remaps_Loader {
	...
	/**
	 * The array of filters to be deregisterd with WordPress after plugin execution.
	 *
	 * @since    1.0.0
	 * @access   protected
	 */
	...
	/**
	 * Add a new filter to the collection to be deregistered with WordPress.
	 *
	 * @since    1.0.0
	...
	/**
	 * Register the cleanup filters and actions with WordPress.
	 *
	 * @since    1.0.0
	 */
